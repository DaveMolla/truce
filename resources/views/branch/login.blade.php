...
<head>
    ...
    <title>Nexus Bingo Branch Login</title>
...
<body class="bg-gray-800 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
        <div class="flex justify-center mb-6">
            <img src="{{asset('images/logo.png')}}" alt="Nexus Bingo" class="">
        </div>
        <h2 class="text-2xl font-bold text-white mb-6 text-center">Sign in to your account</h2>

        <form method="POST" action="{{ route('branch.login') }}" class="max-w-sm mx-auto">
            @csrf
